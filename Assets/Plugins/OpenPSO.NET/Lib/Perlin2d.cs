...
namespace OpenPSO.Lib
{
    public static class Perlin2d
    {
        ...
        public static double Evaluate(double x, double y)
        {
            ...
            double low = SmoothInterpolation(s, t, x_frac);
            double high = SmoothInterpolation(u, v, x_frac);
            double result = SmoothInterpolation(low, high, y_frac);

            // Return value between 0 and 1
            return Math.Abs(result / 255.0f);
        }
    }
}
